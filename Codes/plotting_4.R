...
SeroModelConstantIFR <- readRDS(paste(folder,"/SeroModelConstantIFR_4.rds", sep = ""))
...
folder_strings = unlist(strsplit(getwd(), '/'))
folder_strings[length(folder_strings)] = "Data4"
folder = paste(folder_strings, sep = "", collapse = "/")
...
styled1NorthEastYorkshireHumber4 <- p1NorthEastYorkshireHumber +
  scale_fill_brewer(palette = "Dark2")+
  scale_colour_brewer(palette = "Dark2")+
  theme_minimal() +
  ylab(" ") +
...
styled1EastofEngland4 <- p1EastofEngland +
  scale_fill_brewer(palette = "Dark2")+
  scale_colour_brewer(palette = "Dark2")+
  theme_minimal() +
  ylab("") +
...
grid.arrange(styled1London4,styled1NorthEastYorkshireHumber4,styled1NorthWest4,styled1SouthWest4,styled1SouthEast4,styled1Midlands4,styled1EastofEngland4, layout_matrix = lay)
