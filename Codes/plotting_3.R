...
SeroModelConstantIFR <- readRDS(paste(folder,"/SeroModelConstantIFR_3.rds", sep = ""))
...
folder_strings = unlist(strsplit(getwd(), '/'))
folder_strings[length(folder_strings)] = "Data3"
folder = paste(folder_strings, sep = "", collapse = "/")
...
styled1NorthEastYorkshireHumber3 <- p1NorthEastYorkshireHumber +
  scale_fill_brewer(palette = "Dark2")+
  scale_colour_brewer(palette = "Dark2")+
  theme_minimal() +
  ylab(" ") +
...
styled1EastofEngland3 <- p1EastofEngland +
  scale_fill_brewer(palette = "Dark2")+
  scale_colour_brewer(palette = "Dark2")+
  theme_minimal() +
  ylab("") +
...
grid.arrange(styled1London3,styled1NorthEastYorkshireHumber3,styled1NorthWest3,styled1SouthWest3,styled1SouthEast3,styled1Midlands3,styled1EastofEngland3, layout_matrix = lay)
