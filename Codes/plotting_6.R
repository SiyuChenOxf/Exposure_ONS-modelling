...
SeroModelConstantIFR <- readRDS(paste(folder,"/SeroModelConstantIFR_6.rds", sep = ""))
...
styled1NorthEastYorkshireHumber6 <- p1NorthEastYorkshireHumber +
  scale_fill_brewer(palette = "Dark2")+
  scale_colour_brewer(palette = "Dark2")+
  theme_minimal() +
  ylab(" ") +
...
styled1EastofEngland6 <- p1EastofEngland +
  scale_fill_brewer(palette = "Dark2")+
  scale_colour_brewer(palette = "Dark2")+
  theme_minimal() +
  ylab("") +
...
grid.arrange(styled1London6,styled1NorthEastYorkshireHumber6,styled1NorthWest6,styled1SouthWest6,styled1SouthEast6,styled1Midlands6,styled1EastofEngland6, layout_matrix = lay)
