...
SeroModelConstantIFR <- readRDS(paste(folder,"/SeroModelConstantIFR_5.rds", sep = ""))
...
folder_strings = unlist(strsplit(getwd(), '/'))
folder_strings[length(folder_strings)] = "Data5"
folder = paste(folder_strings, sep = "", collapse = "/")
...
styled1NorthEastYorkshireHumber5 <- p1NorthEastYorkshireHumber +
  scale_fill_brewer(palette = "Dark2")+
  scale_colour_brewer(palette = "Dark2")+
  theme_minimal() +
  ylab(" ") +
...
styled1EastofEngland5 <- p1EastofEngland +
  scale_fill_brewer(palette = "Dark2")+
  scale_colour_brewer(palette = "Dark2")+
  theme_minimal() +
  ylab("") +
...
grid.arrange(styled1London5,styled1NorthEastYorkshireHumber5,styled1NorthWest5,styled1SouthWest5,styled1SouthEast5,styled1Midlands5,styled1EastofEngland5, layout_matrix = lay)
